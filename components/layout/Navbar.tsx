...
const Navbar = () => {
  ...
  return (
    <header
      className={`w-full z-50 fixed top-0 left-0 transition-all duration-500 ease-in-out
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-0 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            href="/contact"
            className="px-5 py-2 text-sm font-semibold text-white bg-[#2089CA] rounded-full
              hover:bg-[#1a70a8] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
          >
            Contact Us
          </Link>
        </div>
